...
* **Live Canvas verification.** Like #60, this ships with full unit/integration coverage but the first real run will be against Kevin's BSU sandbox course. Plan that as a manual test before the v0.9 → v1.0 cut.
