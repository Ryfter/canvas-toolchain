...
`packages/command-and-control` now imports this project as the real local npm package `@canvas-toolchain/canvas-design-studio`. Do not use or document the stale package name `canvas-design-studio-mcp`.
